...
# Esempio di utilizzo diretto in notebook
# (al posto del blocco `if __name__ == "__main__":` da riga di comando,
# che in Colab/Jupyter riceve argomenti del kernel come "-f ..." e va in errore).
